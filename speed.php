...
$_SESSION['petspeed'] = $_SESSION['petspeed'] + $_SESSION['statgain'];
$_SESSION['statgain'] = $_SESSION['statgain']. " speed!";

$petspeed = $_SESSION['petspeed'];
$username = $_SESSION['logged_in_user'];

//Updates the database wit the new stat and redirects to the training page.
$sql = "UPDATE virtualpet SET Speed = '$petspeed' WHERE username = '$username'";
